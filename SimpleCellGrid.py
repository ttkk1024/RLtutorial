...
class Car(object):
    ...
    pass
car = Car()
car.zhgzn = "LD0810000001182"
car.zhgrq  = "2014-10-05"
car.ename  = "山东梅拉德能源动力科技有限公司"
car.carname= "雷丁牌"
car.zpzmx = "D50福享2014版"
car.zclsbn = "BDW8212S8EW009197"
car.zys = "象牙白"
car.zdjlx = "直流他励驱动电机"
car.zdjn = "DPD14090431"
car.zkzqn = "20140814031"
car.dclx  = "动力免维护胶体电池"
car.zjgl = "48V  4KW"
...
I = Image('rml/img/dhqme_qrcode.jpg')
...
data= [['1.合格证编号',car.zhgzn , '2.发证日期',car.zhgrq ],
       ...
       ['车辆生成单位名称:山东梅拉德能源动力科技有限公司', '', '', ''],
       ['生产单位地址:山东省潍坊市昌乐县比德文千亩产业园', '', '', '']]
#t=Table(data,26*[1.2*inch], 4*[0.4*inch])
